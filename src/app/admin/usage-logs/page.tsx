    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed] flex overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-[#1f2937] rounded-lg p-8 border border-[#374151] text-center">
          <h2 className="text-xl font-semibold mb-4">UI Demo - Usage Logs</h2>
          <p className="text-[#9ca3af]">This is a UI-only demo. Usage logs functionality is not implemented.</p>
        </div>
      </div>
      </main>
    </div>
