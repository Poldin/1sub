...
export default function VendorSidebar({ isOpen, onClose }: VendorSidebarProps) {
  ...
  const menuItems = [
    ...
    { name: 'My Tools', href: '/vendor-dashboard/tools', icon: Settings },
    { name: 'Users', href: '/vendor-dashboard/users', icon: Users },
    { name: 'Publish Tool', href: '/vendor-dashboard/publish', icon: Plus },
    { name: 'Transactions', href: '/vendor-dashboard/transactions', icon: BarChart3 },
    { name: 'Analytics', href: '/vendor-dashboard/analytics', icon: BarChart3 },
    { name: 'API', href: '/vendor-dashboard/api', icon: Key },
  ];
