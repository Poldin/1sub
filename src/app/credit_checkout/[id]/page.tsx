    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed]">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Left Column - Product Details and Plan Selection */}
            ...
            <div className="space-y-6">
              ...
              {!isCompleted && (hasProducts || hasPricingOptions) && (
                ...
                {hasProducts && checkout.metadata.products!.map((product: CheckoutProduct) => {
                  ...
                  const isSelected = selectedPricing === product.id;
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-6 rounded-xl border-2 transition-all text-left group relative overflow-hidden ${isSelected
                ...
                {/* Pricing Options Selection (Legacy) */}
                  ...
                  <>
                    {checkout.metadata.pricing_options?.one_time?.enabled && (
                      <button
                        ...
                        className={`w-full p-6 rounded-xl border-2 transition-all text-left ${selectedPricing === 'one_time'
                          ? 'border-[#3ecf8e] bg-[#3ecf8e]/5 shadow-lg shadow-[#3ecf8e]/10'
                          : 'border-[#374151] hover:border-[#4b5563] bg-[#0a0a0a]/30'
                          }`}
                      >
                    ...
                    {checkout.metadata.pricing_options?.subscription_monthly?.enabled && (
                      <button
                        ...
                        className={`w-full p-6 rounded-xl border-2 transition-all text-left ${selectedPricing === 'subscription_monthly'
                          ? 'border-[#3ecf8e] bg-[#3ecf8e]/5 shadow-lg shadow-[#3ecf8e]/10'
                          : 'border-[#374151] hover:border-[#4b5563] bg-[#0a0a0a]/30'
                          }`}
                      >
                    ...
                    {checkout.metadata.pricing_options?.subscription_yearly?.enabled && (
                      <button
                        ...
                        className={`w-full p-6 rounded-xl border-2 transition-all text-left ${selectedPricing === 'subscription_yearly'
                          ? 'border-[#3ecf8e] bg-[#3ecf8e]/5 shadow-lg shadow-[#3ecf8e]/10'
                          : 'border-[#374151] hover:border-[#4b5563] bg-[#0a0a0a]/30'
                          }`}
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <div className="text-lg font-bold text-[#ededed]">Yearly Subscription</div>
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-sm text-[#9ca3af]">/yr</div>
                          </div>
                        </div>
                      </button>
                    )}
