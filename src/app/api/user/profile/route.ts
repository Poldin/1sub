...
export async function GET() {
  try {
    ...
    console.log('Profile API - User ID:', authUser.id);
    console.log('Profile API - Transactions count:', transactions?.length || 0);
    console.log('Profile API - Calculated credits:', totalCredits);
