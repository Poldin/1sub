/**
 * API Endpoint: /api/vendor/analytics/revenue
 * 
...
import { getToolRevenueMetrics } from '@/lib/analytics-engine';
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get revenue metrics
    const metrics = await getToolRevenueMetrics(toolId, startDate, endDate);
