 ...
 * 
 * This endpoint handles direct tool usage with immediate credit deduction.
 * It's used for tools that charge credits per use rather than subscriptions.
 * 
 * REFACTORED: Now uses improved consume_credits RPC with atomic operations.
 */
