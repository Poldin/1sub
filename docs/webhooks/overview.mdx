...
<AccordionGroup>
<Accordion title="user.session_expired">
Sent when a user's session expires (informational).
...
- Most tools can ignore this event
...
<CardGroup cols={2}>
<Card title="View Event Details" icon="list" href="/webhooks/events">
  Complete reference of all webhook event types and payloads
</Card>

<Card title="Implement Security" icon="shield" href="/webhooks/security-and-signing">
  Learn how to verify webhook signatures
</Card>

<Card title="Test Webhooks" icon="flask" href="/webhooks/testing">
  Set up local testing with ngrok and test events
</Card>

<Card title="See Examples" icon="code" href="/examples/node">
