...
<CardGroup cols={2}>
<Card title="Subscription Verification" icon="check-circle" href="/docs/api/reference#verify-subscription">
...
<Card title="Link Code Exchange" icon="link" href="/docs/api/reference#exchange-link-code">
